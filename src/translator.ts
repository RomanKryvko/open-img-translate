...
export interface Translator {
  ...
  translate: (src: LangCode | undefined, target: LangCode, text: string) => Promise<TranslationResult>;
};

export class GoogleTranslator implements Translator {
  supportedLangs: LanguageList = {
  };
  translate = async (src: LangCode | undefined, target: LangCode, text: string): Promise<TranslationResult> => {
